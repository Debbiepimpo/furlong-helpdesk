...
(function(factory) {
    ...
    'use strict';
    var BookCalendar = window.BookCalendar || {};
    ...
    BookCalendar = (function() {
        ...
        function BookCalendar(element, settings) {
    ...
    BookCalendar.prototype.init = function(creation) {
    ...
    BookCalendar.prototype.buildCalendar = function(val, new_month, new_year) {
        var _ = this;
    ...
    BookCalendar.prototype.setHTML = function(val) {
        var _ = this;
    ...
    // Add calendar events
    BookCalendar.prototype.initCalendarEvents = function() {
        var _ = this;
        // prevent duplication
    ...
    // Add listeners
    BookCalendar.prototype.initEventListener = function() {
        var _ = this;
    ...
    // select year
    BookCalendar.prototype.selectYear = function(event) {
        var _ = this;
    ...
    // select month
    BookCalendar.prototype.selectMonth = function(event) {
        var _ = this;
    ...
    BookCalendar.prototype.selectDate = function(event) {
        var _ = this;
    ...
    // toggle sidebar
    BookCalendar.prototype.toggleSidebar = function(event) {
        var _ = this;
    ...
    // toggle event list
    BookCalendar.prototype.toggleEventList = function(event) {
        var _ = this;
    ...
    // toggle event list
    BookCalendar.prototype.addCalendarEvent = function(new_data) {
        var _ = this;
        var data = new_data;
    ...
    BookCalendar.prototype.parseFormat = function(format) {
        var _ = this;
    ...
    BookCalendar.prototype.isValidDate = function(d){
        return new Date(d) && !isNaN(new Date(d).getTime());
    }
    BookCalendar.prototype.formatDate = function(date, format, language){
        var _ = this;
        if (!date)
            return '';
    ...
    $.fn.bookCalendar = function() {
        ...
        for (i = 0; i < l; i++) {
            if (typeof opt == 'object' || typeof opt == 'undefined')
                _[i].bookCalendar = new BookCalendar(_[i], opt);
            else
                ret = _[i].bookCalendar[opt].apply(_[i].bookCalendar, args);
